...
<body>
    <div id="loginForm">
        <form action="login.do" method="post" id="saveForm">
        	<input name="id" value="2" type="hidden" id="id"/>
            <p>
            	<input id="userName" name="uid" type="text" placeholder="学号"/>
            </p>
            <p>
           ...
           <p>
            ...
            <p>
                <input id="btLogin" type="submit" value="登录" name="button01"></p>
         	<p>
       ...
       function changeCode(){
        ...
        $(function () {
            ...
            $("input[id='userName']").blur(function () {
                ...
                //3.校验名称不能为空
                if(userNameVal=='') {
                    $("#message").html("<font color='red'>*学号不能为空</font>");
                    return;
                }else{
                	$("#message").html("");  
                }
...
//            $("input[id='yanzhengma']").blur(function () {
//                //2.获取文本框中的值
