...
<body>
 ...
 <div id="loginForm">
		 <p>
			<span id="zhuce">注册账号</span>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<span><a href="tologin.do">已有账号，去登录</a></span>
		 </p>
 	
        <form action="add.do" method="post" id="form01">
        <input name="ubnum" value="0" type="hidden"/>
            <p><input id="uid" name="uid" type="text" placeholder="学号"/>
            </p>
            <p><input id="userName" name="uname" type="text" placeholder="用户名"/>
            </p>
            <p>
             <span id="userNamemessage"></span>
            </p>
            <p><input id="password" name="upwd" type="password" placeholder="密码"/>
            </p>
            <p>
            ...
            <p>
                <input id="btLogin" type="submit" value="注册" onClick="check()"></p>
        </form>
    </div>
</body>
<script >
