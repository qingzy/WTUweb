...
<body>
 ...
 <div id="loginForm">
    <c:if test="${empty user}">
		 ...
		 <p>
			<span id="zhuce">修改信息</span>
		 </p>
 	
        <form action="updateUser.do" method="post" id="form01">
        <input name="ubnum" value="${user.ubnum}" type="hidden"/>
            <p><input id="uid" name="uid" type="text" placeholder="学号" value="${user.uid}" disabled="disabled"/>
            </p>
            <p><input id="userName" name="uname" type="text" placeholder="用户名" value="${user.uname}"/>
            </p>
            <p>
             <span id="userNamemessage"></span>
            </p>
            <p><input id="password" name="upwd" type="password" placeholder="密码" value="${user.upwd}"/>
            </p>
            <p>
            ...
            <p>
                <input id="btLogin" type="submit" value="修改" onClick="check()"></p>
        </form>
    </div>
</body>
<script >
